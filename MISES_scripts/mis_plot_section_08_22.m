...
% 	nj_mid = round(0.5*g{1}.attribute.nj);
    ...
    [rad_contr,AtA1,AtA1_roV,rad_contr_o] = mis_radial_contraction(directory);
    bl_inc = 1;
    [rad_contr_bl,AtA1_bl,AtA1_roV_bl,rad_contr_o_bl] = mis_radial_contraction(directory,0,bl_inc);
...
%     varnames_2 = {'oscosa' 'chi_te' 'chi_le' 's_c'};
    ...
    M_contours = [0.3 0.4 0.5 0.6 0.7 0.8 0.9 1.05 1.1 1.15 1.2 1.25 1.30 1.35 1.40];
    [C,f]=contour(Idat.x_cell.*c.r_le,Idat.y_cell.*c.r_le+pitch,Idat.M,M_contours,'Color',[0.25,0.25,0.25]);
